...
public class BALANCES extends javax.swing.JFrame {
    ...
    public BALANCES(String a,String b) {
        x=a;
        y=b;
    ...
    public static void main(String args[]) {
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
//                new BALANCES( args.length > 0 ? args[0] : "").setVisible(true);
String accountNumber = args.length > 0 ? args[0] : "";
            String balance = args.length > 1 ? args[1] : "";
            new BALANCES(accountNumber, balance).setVisible(true);
            }
        });
    }
